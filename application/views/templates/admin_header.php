        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id=" main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('admin'); ?>"> <i class="menu-icon fa fa-lg fa-fw fa-home"></i>DASHBOARD
                        </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-lg fa-folder-o"></i>LAPORAN</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-lg fa-file-text-o"></i>CETAK</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?= base_url('admin'); ?>"><i class="fa fa-user"></i>
                                <?= $user['nama']; ?></a>
