...
<head>
    ...
    <!-- <link rel="icon" type="image/jpg" sizes="32x32" href="<?= base_url(); ?>assets/images/logo.jpg"> -->
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= base_url('admin'); ?>"><img src="<?= base_url(); ?>assets/images/logo_smp_putih.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="<?= base_url(); ?>assets/images/logo2.png" alt="Logo"></a>
            </div>
            <div class="navbar-header mt-3">
                <!-- <img class="user-avatar rounded-circle" width="80" height="80" src="<?= base_url(); ?>assets/images/ava.png" alt="User Avatar"> -->
                <h5>
                    <font color="white">
                        <?= $user['keterangan']; ?> <br><br>
            ...
            <div id=" main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('home'); ?>"> <i class="menu-icon fa fa-lg fa-fw fa-home"></i>DASHBOARD
                        </a>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <?php if ($user['id_akses'] == 1) : ?>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-lg fa-cogs"></i>MASTER</a>
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li>
                                    <a href="<?= base_url('pengajar'); ?>">
                                        <i class="fa-fw fa fa-folder-open-o"></i>Pengajar
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('jam'); ?>">
                                        <i class="fa-fw fa fa-folder-open-o"></i>Jam Pelajaran
                                    </a>
                                </li>
                            </ul>
                    </li>
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-lg fa-folder-o"></i>CETAK LAPORAN</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li>
                            <a href="<?= base_url('jurnal_mengajar'); ?>">
                                <i class="fa-fw fa fa-folder-open-o"></i>Jurnal Mengajar
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('presensi'); ?>">
                                <i class="fa-fw fa fa-folder-open-o"></i>Presensi
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('tampil_jadwal'); ?>">
                                <i class="fa-fw fa fa-folder-open-o"></i>Jadwal Pelajaran
                            </a>
                        </li>
                    </ul>
                ...
                <?php if ($user['id_akses'] == 1) : ?>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-lg fa-file-text-o"></i>CETAK DATA</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li>
                                <a href="<?= base_url('cetak_lap'); ?>">
                                    <i class="fa-fw fa fa-file"></i>Data
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('cetak_filter'); ?>">
                                    <i class="fa-fw fa fa-file"></i>Data Siswa
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?= base_url('laporan_absensi_siswa'); ?>">
                                    <i class="fa-fw fa fa-file"></i>Presensi
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('tampil_jadwal'); ?>">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?= base_url('home'); ?>"><i class="fa fa-user"></i>
                                <?= $user['nama']; ?></a>
